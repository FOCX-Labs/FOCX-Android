...
class VoteOnProposalUseCase @Inject constructor(
    ...
    suspend fun execute(proposalId: String, voteType: VoteType, voterPubKey: SolanaPublicKey, activityResultSender: ActivityResultSender): Result<Vote> {
        return try {
            ...
            if (votingPower <= 0) {
                ...
                governanceRepository.voteOnProposal(proposalId, voteType, voterPubKey, activityResultSender)
            }
        } catch (e: Exception) {
            Result.failure(e)
        }
